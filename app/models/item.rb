class Item < ApplicationRecord
  ...
  validates :price,              presence: true, numericality:{ with: /\A[0-9]+\z/, allow_blank: true , greater_than_or_equal_to: 300, less_than_or_equal_to: 9_999_999, allow_blank: true  }
